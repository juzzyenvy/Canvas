...
window.canvasExtension.initCanvasExtensionMenu = function() {
  ...
  var menuHTML = " \
    <div id='extensionMenu' class='' style='z-index: 10; background: #EEE; position: fixed; top: 0; right: 0; padding: 5px; text-align: right; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.75); font-size: 0.5em; line-height: 1em; '> \
      <a title='Accept Enrolment' onClick='window.canvasExtension.testButton()' class='btn btn-success' style='padding: 0.5em;'><i class='icon-mini-arrow-down'></i></a> \
      <a title='Change settings' onClick='window.canvasExtension.restrictsetting()' class='btn btn-success' style='padding: 0.5em;'><i class='icon-mini-arrow-down'></i></a> \
...
window.canvasExtension.makeEdits = function() {
  ...
  .replace(/\.htm/g,' [HTM, XX]')
  .replace(/\.jpg/g,' [JPG, XX]')
...
window.canvasExtension.addreturnbutton = function() {
  ...
  content = content.replace(/<hr \/>/g,'<p>&nbsp;</p><p><a href="#index">Return to index</a></p><hr />');
...
window.setTimeout(window.canvasExtension.removeTables, 500);
window.setTimeout(window.canvasExtension.makeEdits, 700);
window.setTimeout(window.canvasExtension.removephantom, 1000);
 }
